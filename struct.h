...
struct regionalcontrol regcontrol[45];
...
struct manscecontrol mscecontrol[45];
...
struct autoscecontrol ascecontrol[25];
...
struct autoscetri
{
    struct autoaction autotion[25];
    int id;
    int ldentification;
    time_t lasttime;
};
struct autoscetri autotri[25];
