            ...
            while(1)
            {
                ...
                switch(tricond[typea])
                {
                    ...
                    case 0x07:
                        ...
                        {
                            pr_debug("条件检查0：人体感应\n");
                            if(((nodedev[autoscene_h[2]].nodeinfo[2] > 0) && (nodedev[autoscene_h[2]].nodeinfo[2] < 0x0f)) || ((nodedev[autoscene_h[2]].nodeinfo[2] > 0x71) && (nodedev[autoscene_h[2]].nodeinfo[2] < 0x80)))
                            {
                                //是否使能
                                if(nodedev[autoscene_h[2]].nodeinfo[2] == 0x0a)
                                {
                                    node_enable = 1;
                                }
                                else
